...
public partial class RainbowDetailedTimerSettings : UserControl
{
    ...
    {
        get => RainbowTimerSettings.GetBackgroundTypeString(BackgroundGradient);
    ...
    public RainbowDetailedTimerSettings()
    {
        InitializeComponent();
