...
public class RainbowDetailedTimer : IComponent
{
    public RainbowTimer InternalComponent { get; set; }
    ...
    public RainbowDetailedTimerSettings Settings { get; set; }
    ...
    public RainbowDetailedTimer(LiveSplitState state)
    {
        InternalComponent = new RainbowTimer();
        SegmentTimer = new SegmentTimer();
        Settings = new RainbowDetailedTimerSettings()
        {
            CurrentState = state
        };
        IconWidth = 0;
    ...
    {
        RainbowTimer.DrawBackground(g, InternalComponent.TimerColor, Settings.BackgroundColor, Settings.BackgroundColor2, width, height, Settings.BackgroundGradient);
